package com.susankaranja.firebase.Data
...
import com.susankaranja.firebase.Models.Product
import com.susankaranja.firebase.Models.Upload
import com.susankaranja.firebase.Navigation.ROUTE_LOGIN
...
class productviewmodel(var navController: NavHostController, var context: Context) {
    ...
    fun viewProducts(
        product: MutableState<com.susankaranja.firebase.Models.Product>,
        products: SnapshotStateList<com.susankaranja.firebase.Models.Product>
    ): SnapshotStateList<com.susankaranja.firebase.Models.Product> {
        ...
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children) {
                    val value = snap.getValue(com.susankaranja.firebase.Models.Product::class.java)
                    product.value = value!!
                    products.add(value)
                }
            }
    ...
    fun updateProduct(name: String, quantity: String, price: String, id: String) {
        var updateRef = FirebaseDatabase.getInstance().getReference()
            .child("Products/$id")
        progress.show()
        var updateData = com.susankaranja.firebase.Models.Product(name, quantity, price, id)
